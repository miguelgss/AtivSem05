...
namespace LanchesMac.Models
{
    public class CarrinhoCompra
    {
        ...
        public void AdicionarAoCarrinho(Lanche lanche)
        {
            ...
            else // Se o carrinho existir, então incrementa a quantidade do item
            {
        ...
        public int RemoverDoCarrinho(Lanche lanche)
        {
            ...
            if (carrinhoCompraItem != null)
            {
                if (carrinhoCompraItem.Quantidade > 1) // Se a quantidade for maior do que 1 ela é decrementada
                {
                    carrinhoCompraItem.Quantidade--;
                    quantidadeLocal = carrinhoCompraItem.Quantidade;
                }
                else // Se não, remove o item do carrinho
                {
        ...
        {
            // O "??" avalia se uma variável é nula ou não. Caso não seja, ele executará o Get
